 ...
 *
 * Description: This DAO class handles updating the exam status to 'RETIRED' in the database for a given exam name.
 */
public class RetireExamDAO {
	 ...
	 *
	 * @param request
	 *            the HttpServletRequest object containing the exam name to retire
	...
	public static boolean retireExam(HttpServletRequest request) {
		...
		// String examName = (String) request.getSession().getAttribute("activeExam");
		System.out.println("RetireExamDAO - examname: " + examName);
		boolean flag = false;
		String sql = "update exam  " + "set status='RETIRED' where exam_name = ?";
