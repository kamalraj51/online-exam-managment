 ...
 *
 * Description: This DAO class is responsible for inserting new exams into the database.
 *
 * It takes exam details from the request object and inserts them into the 'exam' table. It also sets the generated exam ID in the request
