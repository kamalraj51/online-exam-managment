 ...
 *
 * Description: This DTO represents a user's response to a question along with correctness and option details.
 */
public class ExamResponseDTO {
	...
	public String toString() {
		return "ExamResponseDTO [responseId=" + responseId + ", questionId=" + questionId + ", selectedOptionId=" + selectedOptionId
						+ ", isCorrect=" + isCorrect + ", questionText=" + questionText + ", selectedOptionText=" + selectedOptionText
