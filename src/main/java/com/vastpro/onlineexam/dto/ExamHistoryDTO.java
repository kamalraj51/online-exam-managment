 ...
 *
 * Description: This DTO class represents the exam history of a user. It stores details such as exam information, user results, marks,
 * duration taken, and question statistics (correct/incorrect/unanswered).
 */
public class ExamHistoryDTO {
	...
	public String toString() {
		return "ExamHistoryDTO [examName=" + examName + ", dateTime=" + dateTime + ", yourMarks=" + yourMarks + ", correct=" + correct
