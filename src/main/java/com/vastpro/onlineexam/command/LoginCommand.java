...
public class LoginCommand implements Command {
	...
	public boolean execute(HttpServletRequest request, HttpServletResponse response) {
		 ...
		 * "Invalid email.Enter a valid email address."); return false; }
		 * 
		 * // Password validation (min 8 chars, uppercase, lowercase, number) if
		 * (password == null) { request.setAttribute("passwordError",
		 * "Password must be at least 8 characters long."); return false; }
		 */
